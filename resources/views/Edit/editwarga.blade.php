...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <a href="{{route('warga.index')}}" class="sidebar-toggle" data-toggle="offcanvas" role="button">
            {{ __('Back To Warga') }}
        </a>
        ...
        <body class="hold-transition login-page">
            <div class="login-box">
                ...
                <div class="login-box-body">
                    <b>
                        <p class="login-box-msg">Edit Data Warga</p>
                    </b>
                    @foreach($warga as $p)

                    <form action="/warga/update" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input id="tanggal_Lahir" name="ttl" type="date" class="form-control" value="{{$p->tanggal_lahir}}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="JK" class="form-control">
                                        <option selected>{{$p->jenis_kelamin}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="No_Telp" type="text" class="form-control" value="{{$p->no_hp}}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
