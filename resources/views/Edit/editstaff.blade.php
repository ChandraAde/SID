...
<head>
 ...
 <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <a href="{{route('user.index')}}" class="sidebar-toggle" data-toggle="offcanvas" role="button">
            {{ __('Back To Staff') }}
        </a>
        ...
        <body class="hold-transition login-page">
            <div class="login-box">
                ...
                <div class="login-box-body">
                    <b>
                        <p class="login-box-msg">Edit Data Staff</p>
                    </b>
                    ...
                    <form action="/user/update" name="modal_popup" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <input name="jabatan" type="text" class="form-control" value="{{$p->jabatan}}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="Alamat" type="text" class="form-control" value="{{$p->No_Hp}}" />
                            </div>
                        </div>
